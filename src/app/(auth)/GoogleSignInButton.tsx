...
const GoogleSignInButton = () => {
  return (
    <Button className="bg-white text-black hover:bg-gray-100 hover:text-primary" variant="outline" asChild>
      <a className="flex w-full items-center gap-3" href="/login/google">
